...
class VoucherController extends Controller
{
    ...
    public function rvprint($id)
    {
        $voucher = Voucher::with('voucherDetails.account')->findOrFail($id);

         // Retrieve the company details from the session
         $companyId = session('company_id');
         $company = Company::findOrFail($companyId);

        return view('accounting.vouchers.rvprint', compact('voucher','company'));
    }

    public function pvprint($id)
    {
        $voucher = Voucher::with('voucherDetails.account')->findOrFail($id);
        ...
        return view('accounting.vouchers.pvprint', compact('voucher','company'));
    }

    public function jvprint($id)
    {
        $voucher = Voucher::with('voucherDetails.account')->findOrFail($id);
        ...
        return view('accounting.vouchers.jvprint', compact('voucher','company'));
    }



    //jameel testing for opening balances
