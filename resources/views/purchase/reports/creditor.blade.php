...
<html lang="en">
  <head>
    ...
    <title>Creditor Report | QuickERP</title>
    ...
    <div class="invoice-container max-w-full mx-auto bg-white p-6">
      <div class="flex items-center justify-between border-b pb-4">
        ...
        <div class="text-right">
          <h2 class="text-2xl font-bold uppercase mb-1 text-black">Creditor Report</h2>
            ...
            <table class="min-w-full table-auto border-collapse border border-gray-300">
              <thead>
                <tr>
                  ...
                  <th class="px-2 py-1 border-b text-left text-sm font-semibold text-gray-600 w-1/3">Vendor</th>
                  ...
                  <th class="px-2 py-1 border-b text-left text-sm font-semibold text-gray-600">Purchases
                  <br/><small>({{ $selectedMonth }}) </small>

                  </th>
                  <th class="px-2 py-1 border-b text-left text-sm font-semibold text-gray-600">Payments
                  <br/><small>({{ $selectedMonth }}) </small>
                  </th>
