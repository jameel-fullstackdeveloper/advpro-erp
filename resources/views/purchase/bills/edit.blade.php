...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-sm-flex align-items-center justify-content-between bg-galaxy-transparent">
            <h4 class="mb-sm-0 card-title">Edit Purchase (Mill)</h4>
            <div class="page-title-right">
                <ol class="breadcrumb m-0">
                    <li class="breadcrumb-item"><a href="javascript: void(0);">Purchase</a></li>
                    <li class="breadcrumb-item active">Purchase (Mill) > Edit</li>
                </ol>
            </div>
        </div>
    </div>
...
<div class="row">
    <div class="col-lg-12">
        ...
        <form method="POST" action="{{ route('bills.update', $purchaseBill->id) }}">
            ...
            <div class="row mb-3">
                <div class="col-md-6">
                    ...
                    <select name="order_id" class="form-select" required>
                        ...
                        <option value="{{ $order->id }}" {{ old('order_id', $purchaseBill->order_id) == $order->id ? 'selected' : '' }}>
                        {{ $order->order_number }} - Date: {{ \Carbon\Carbon::parse($order->order_date)->format('Y-m-d') }}
                    </option>
                        @endforeach
                    </select>
