...
<div class="row">
    <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between bg-galaxy-transparent">
                <h4 class="mb-sm-0 card-title">Create Purchase Bill (Farm)</h4>
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a href="javascript: void(0);">Purchase</a></li>
                            <li class="breadcrumb-item active">Purcase Bills (Farm) > Create</li>
                       </ol>
                    </div>
...
<div class="row">
    ...
    @if ($errors->any())
            ...
            <form method="POST" action="{{ route('billsfarms.store') }}">
            @csrf
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    let index = 0;  // Initialize index here, before using it
    const tableBody = document.querySelector('#invoice-items-table tbody');

    // Add the first row by default when the page loads
    addRow({
        product_id: '',  // You can add a default product id or leave it empty
        product_name: '', // You can add a default product name or leave it empty
    ...
    newRow.innerHTML = `
        ...
        <td class="text-center">
            <a href="#" class="link-danger remove-row">
                <i class="ri-delete-bin-line d-none" style="font-size:18px;"></i>
            </a>
        </td>
    `;
