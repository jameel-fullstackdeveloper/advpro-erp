...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-sm-flex align-items-center justify-content-between bg-galaxy-transparent">
            <h4 class="mb-sm-0 card-title">Create Sale (Mill) </h4>
            <div class="page-title-right">
                <ol class="breadcrumb m-0">
                    <li class="breadcrumb-item"><a href="javascript: void(0);">Sales</a></li>
                    <li class="breadcrumb-item active"><a href="{{ url('sales/invoices') }}"> Mill </a>> Create</li>
                </ol>
            </div>
        </div>
    </div>
        ...
        <div class="col">
            ...
            <form action="{{ route('invoices.store') }}" method="POST">
                ...
                <div class="invoice-section">
                    <h5 class="section-heading tabheading mb-2 ">Sale Invoice Details</h5>
                    ...
                    <div class="row">
                        <div class="col-md-2">
                            ...
                            <input type="number" name="invoice_due_days" class="form-control shadow-sm" placeholder="Due Days"
                                value="{{ old('invoice_due_days') }}" required />
                        ...
                        <div class="col-2">
                            ...
                            <input type="text" name="farm_name" class="form-control table-input" value="{{ old('farm_name') }}">
                            @error('farm_name') <span class="text-danger">{{ $message }}</span> @enderror
                        </div>

                        <div class="col-4">
                            <label for="farm_address">Farm Address</label>
                            <input type="text" name="farm_address" class="form-control table-input" value="{{ old('farm_address') }}">
                            @error('farm_address') <span class="text-danger">{{ $message }}</span> @enderror
                        </div>

                        <div class="col-2">
                            <label for="farm_supervisor_mobile">Supervisor Mobile</label>
                            <input type="text" name="farm_supervisor_mobile" class="form-control table-input" value="{{ old('farm_supervisor_mobile') }}" maxlength="11" pattern="\d{11}" title="Mobile number must be exactly 11 digits" inputmode="numeric">
                        ...
                        <table class="table table-bordered table-striped" id="invoice-items-table">
                            <thead class="table-info"  style="vertical-align: middle;">
                                <tr>
                                    ...
                                    <th class="text-center text-info">Net Amount<br><span class="text-dark" style="font-size:10px">Including Taxes</span></th>
                            ...
                            <tfoot class="table-light">
                                <tr>
                                    ...
                                    <th class="text-center"><span class="total_label" id="total-bonus">0</span></th>
                    ...
                    <div class="brokerage-sectiodn">
                        <div class="row">
                            <h5 class="section-heading tabheading mb-2 mt-3">Commission Details</h5>
                            ...
                            <div class="col-1">
                                ...
                                <input type="number" name="broker_rate" class="form-control table-input" id="broker_rate" step="0.001">
                            ...
                            <div class="col-2">
                                ...
                                <select name="calculation_method" class="form-control form-select shadow-sm" id="calculation_method">
                                    ...
                                    <option value="percentage">Percentage on Amount</option>
                                    <option value="quantity">Multiply by Quantity</option>
                                </select>
                            </div>

                            <div class="col-2">
                                <label for="broker_amount">Brokerage Amount</label>
                                <input type="number" name="broker_amount" class="form-control table-input" id="broker_amount" step="0.001">
                    ...
                    <div class="row">
                        <div class="col-12 text-end mt-3 mb-3">
                            <button type="submit" class="btn btn-success btn-label">
                                <i class="ri-add-circle-line label-icon align-middle fs-16"></i> Create Sale Invoice
                            </button>
                        </div>
                    </div>
                </form>
