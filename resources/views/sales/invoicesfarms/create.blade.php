...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-sm-flex align-items-center justify-content-between bg-galaxy-transparent">
            <h4 class="mb-sm-0 card-title">Create Sale  (Farm) </h4>
            <div class="page-title-right">
                <ol class="breadcrumb m-0">
                    <li class="breadcrumb-item"><a href="javascript: void(0);">Sales</a></li>
                    <li class="breadcrumb-item active"><a href="{{ url('sales/invoices') }}"> Sale (Farm) </a> > Create</li>
                </ol>
            </div>
        </div>
    </div>
...
<div>
    ...
    <div class="row">
        <div class="col">
            ...
            <form action="{{ route('invoicesfarms.store') }}" method="POST">
                @csrf
                <div class="invoice-section">
                    <h5 class="section-heading tabheading mb-2 ">Sale Invoice Details</h5>
                        <div class="row mb-4">
                                <div class="col-4">
                                            <label for="cost_center" class="form-label">Sales  to Credit</label>
