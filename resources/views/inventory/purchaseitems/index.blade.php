...
<div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between bg-galaxy-transparent">
                <h4 class="mb-sm-0">Purchase Items (Raw Material & Others)</h4>
                                        ...
                                        <div class="col-lg-12">
                                            <div class="tab-content">
                                                ...
                                                <div class="tab-pane fade  active show" id="custom-v-pills-types" role="tabpanel" aria-labelledby="custom-v-pills-types-tab">
                                                        <livewire:inventory.purchase.item :key="'tab33-component'"/>
                                                </div>
                                                <!--end tab-pane-->

                                                <div class="tab-pane fade" id="custom-v-pills-messages" role="tabpanel" aria-labelledby="custom-v-pills-messages-tab">
                                                    <livewire:inventory.purchase.itemgroup :key="'tab55-component'"/>
                                                </div>
                                                <!--end tab-pane-->
                                            </div>
                                        </div> <!-- end col-->
