...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-sm-flex align-items-center justify-content-between bg-galaxy-transparent">
            <h4 class="mb-sm-0 card-title">Stock (Materials)
            </h4>
    ...
    <table class="table table-borderless" style="width: 100%; margin: 0; padding: 0; border: none;">
        <tr>
            ...
            <td style="width: 40%; text-align: right; vertical-align: middle; padding: 0;">
                <h2 style="font-size: 1.2rem; font-weight: bold; margin: 0;">Materials Statement</h2>
            </td>
        </tr>
    </table>
</div>
...
<div class="row rownpadding">
    <div class="col-md-12">
        <div class="card shadow-sm">
            <div class="card-header d-flex justify-content-between align-items-center text-white bg-info" style="padding: 10px; border: none; box-shadow: none;">
    ...
    document.getElementById('endbal').textContent = 'Stock: ' + formatNumber(endingBalance) ;
</script>
                    </div>
                </div>
            </div>
