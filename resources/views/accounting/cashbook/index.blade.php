...
<div class="row">
                        <div class="col-12">
                            ...
                            <h4 class="mb-sm-0 card-title">Cash Book</h4>
                   ...
                   <livewire:accounting.cashbook.summarybox />
                                        ...
                                        <div class="col-lg-12">
                                            <div class="tab-content text-muted">
                                                ...
                                                <div class="tab-pane fade  active show" id="custom-v-pills-types" role="tabpanel" aria-labelledby="custom-v-pills-types-tab">
                                                     <livewire:accounting.cashbook.cashbookbreceipt  :key="'tab3-component'" />
                                                </div>
                                                <!--end tab-pane-->

                                                <div class="tab-pane fade" id="custom-v-pills-messages" role="tabpanel" aria-labelledby="custom-v-pills-messages-tab">
                                                     <livewire:accounting.cashbook.cbpayment  :key="'tab077-component'" />
                                                </div>
                                                <!--end tab-pane-->
