                                        ...
                                        <div class="col-lg-12">
                                            <div class="nav nav-pills nav-customs nav-danger nav-border-bottom nav-border-bottom" role="tablist" aria-orientation="vertical">
                                                <a class="nav-link show active" id="custom-v-pills-home-tab" data-bs-toggle="pill" href="#custom-v-pills-home" role="tab" aria-controls="custom-v-pills-home" aria-selected="true">
                                                    <!--<i class="ri-home-4-line d-block fs-20 mb-1"></i> --> Accounts
                                                </a>
                                                ...
                                                <a class="nav-link" id="custom-v-pills-profile-tab" data-bs-toggle="pill" href="#custom-v-pills-types" role="tab" aria-controls="custom-v-pills-profile" aria-selected="false" tabindex="-1">
                                                Account Type
                                                </a>
                                        ...
                                        <div class="col-lg-12">
                                            <div class="tab-content text-muted">
                                                <div class="tab-pane fade active show" id="custom-v-pills-home" role="tabpanel" aria-labelledby="custom-v-pills-home-tab">
                                                    <livewire:accounting.chartofaccount.coa :key="'tab1-component'"/>
                                                </div>
                                                <!--end tab-pane-->

                                                <div class="tab-pane fade" id="custom-v-pills-messages" role="tabpanel" aria-labelledby="custom-v-pills-messages-tab">
                                                    <livewire:accounting.chartofaccount.coagroup :key="'tab2-component'"/>
                                                </div>
                                                <!--end tab-pane-->

                                                <div class="tab-pane fade" id="custom-v-pills-types" role="tabpanel" aria-labelledby="custom-v-pills-types-tab">
                                                    <livewire:accounting.chartofaccount.coatype :key="'tab3-component'"/>
                                                </div>
                                                <!--end tab-pane-->
