        ...
        <div class="navbar-header ">
            <div class="d-flex">
                ...
                <div class="navbar-brand-box horizontal-logo">
                    <!-- Dark Logo-->
                        <a href="{{ url('/') }}" class="logo logo-dark">
                            ...
                            <span class="logo-lg">
                                    <h3 style="color:#000" class="mt-4">QuickERP</h3>
                ...
                <table>
                    <tr>
                        <td><h5 class="mt-2">
                        <img src="{{ $company->avatar ? Storage::disk('spaces')->url($company->avatar) : asset('images/user-dummy-img.jpg') }}"
                        alt="Avatar" class="image avatar-xs rounded-circle" style="width:50px;height:50px;margin-right:10px;">
                        </h5></td>
                        <td>
                            <h4 class="text-success fw-bold fs-18 pt-2 text-uppercase">{{ $company->name  }} <span class="fs-12 text-muted" style="font-weight:600;font-size:12px;color:#555;text-transform:none;" >, {{ $company->address  }}</span> </h4>
                        </td>
                    </tr>
                </table>
            ...
            <div class="d-flex align-items-center">
                ...
                <div class="dropdown ms-1 topbar-head-dropdown header-item d-none" >
                    <button type="button" class="btn btn-icon btn-topbar material-shadow-none btn-ghost-secondary rounded-circle" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        ...
                        @break
                        @case('ur')
                            <img src="{{ URL::asset('build/images/flags/pk.svg') }}" class="rounded" alt="Header Language" height="20">
                        @break
                        @case('it')
                    ...
                    <div class="dropdown-menu dropdown-menu-end">
                        ...
                        <!-- item-->
                        <a href="{{ url('index/ur') }}" class="dropdown-item notify-item language" data-lang="sp" title="Spanish">
                            <img src="{{ URL::asset('build/images/flags/pk.svg') }}" alt="user-image" class="me-2 rounded" height="20">
                            <span class="align-middle">Urdu</span>
                        </a>
                    ...
                    <div class="dropdown-menu dropdown-menu-lg p-0 dropdown-menu-end">
                        <div class="p-3 border-top-0 border-start-0 border-end-0 border-dashed border">
                            <div class="row align-items-center">
                                <div class="col">
                                    <h6 class="m-0 fw-semibold fs-15"> Modules </h6>
                                </div>
                                <div class="col-auto">
                                    <a href="#!" class="btn btn-sm btn-soft-info"> View All Modules
                ...
                <div class="dropdown ms-sm-3 header-item topbar-user ">
                    <button type="button" class="btn material-shadow-none" id="page-header-user-dropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <span class="d-flex align-items-center">
                            ...
                            <span class="text-start ms-xl-2">
                                ...
                                <span class="d-none d-xl-block ms-1 fs-12 user-name-sub-text">{{Auth::user()->roles->pluck('name')->implode('') }}
                                </span>
                            </span>
                        </span>
                    </button>
                    <div class="dropdown-menu dropdown-menu-end">
                        ...
                        <a class="dropdown-item" href="{{ url('user/profile') }}"><i class="mdi mdi-account-circle text-muted fs-16 align-middle me-1"></i> <span class="align-middle">Profile</span></a>
