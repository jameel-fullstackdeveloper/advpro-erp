...
<!-- Spinner element -->
<div wire:loading wire:target="store, update,deleteCustomer,itemsPerPage,searchTerm,filter,imagecbrec" class="spinner"></div>
                    ...
                    <div class="flex-shrink-0">
                        <div class="form-check form-switch form-switch-right form-switch-md">
                            <button type="button" wire:click="createVoucherRV()" class="btn btn-success btn-label">
                                <i class="ri-add-circle-line label-icon align-middle fs-16 me-2"></i> Add Cash Receipt
                            </button>
                        </div>
                    </div>
                </div>
                ...
                @foreach ($creditAccounts as $index => $creditAccount)
                    <tr>
                        @if ($loop->first)
                            ...
                            <td rowspan="{{ $creditAccounts->count() }}"><span class="text-uppercase fs-12 fw-bold">{{ $voucher->reference_number }}</span></td>
                                            ...
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title text-uppercase" id="myModalLabel">
                                                        {{ $isEditing ? 'Edit Receipt Voucher' : 'New Receipt Voucher' }}
                                                    </h5>
                                                    ...
                                                    <div class="row mb-4">
                                                        ...
                                                        <div class="row mb-3">
                                                            ...
                                                            <div class="col-3">
                                                                ...
                                                                <select wire:model.live ="payment_at" class="form-select" id="payment_at">
                                                        ...
                                                        <div class="row mb-3">
                                                                <div class="col-6">
                                                                    <label for="imagecbrec" class="form-label">Upload Image (Optional)</label>
                                                                    <input type="file" class="form-control" id="imagecbrec" wire:model="imagecbrec">
                                                                    @error('imagecbrec') <span class="text-danger">{{ $message }}</span> @enderror
                                                                    </div>
                                                                    <div class="col-6">

                                                                    <!-- Image Preview -->
                                                                    @if ($imagecbrec && method_exists($imagecbrec, 'temporaryUrl'))
                                                                        <div class="mt-2">
                                                                            <img src="{{ $imagecbrec->temporaryUrl() }}" alt="Image Preview" class="img-thumbnail" style="max-height: 200px;">
                                                                        </div>
