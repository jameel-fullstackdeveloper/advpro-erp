                    ...
                    <div class="flex-shrink-0">
                        <div class="form-check form-switch form-switch-right form-switch-md">
                            <button type="button" wire:click="createVoucherPV()" class="btn btn-danger btn-label">
                                <i class="ri-add-circle-line label-icon align-middle fs-16 me-2"></i> Add Cash Payment
                            </button>
                        </div>
                    </div>
                </div>
            ...
            @if ($creditAccounts->isNotEmpty())
                @foreach ($creditAccounts as $index => $creditAccount)
                    <tr>
                        ...
                        @if ($loop->first)
                            <!-- Status and actions only on the first row of each grouped voucher -->
                            <td class="d-none" rowspan="{{ $creditAccounts->count() }}">
                                @if($voucher->status == 1)
                                    <i class="text-success ri-checkbox-circle-line fs-17 align-middle"></i>
                                @else
                                    <i class="text-danger ri-close-circle-line fs-17 align-middle"></i>
                                @endif
                            </td>
                                                ...
                                                @if (session()->has('error'))
                                                    ...
                                                    <div class="row mb-4">
                                                        ...
                                                        <div class="d-flex justify-content-between align-items-center bg-light p-3 mb-3">
                                                            ...
                                                            <span class="text-dark font-size-14 font-weight-bold">{{ number_format($totalAmount, 2) }}</span>
                                                        </div>
