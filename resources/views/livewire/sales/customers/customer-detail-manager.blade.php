                ...
                <div class="card-body">
                    ...
                    @endif
                            ...
                            <div class="col-4 text-end">
                                    ...
                                    <i class="ri-add-circle-line label-icon align-middle fs-16"></i> New Customer </button>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="myModal_customerLabel">{{ $isEditMode ? 'Edit Customer' : 'Add Customer' }}</h5>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select wire:model="group_id" class="form-select">
                                        ...
                                        @foreach (App\Models\ChartOfAccountGroup::where('is_customer_vendor', 'customer')
