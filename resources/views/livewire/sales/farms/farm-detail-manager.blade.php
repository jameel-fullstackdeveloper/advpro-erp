                ...
                <div class="card-body">
                    ...
                    @endif
                            ...
                            <div class="row mb-3">
                               ...
                               <div class="col-md-7 text-left"> <!-- Added ms-auto to push it to the right -->
                                    <div class=" ">
                            ...
                            <div class="col-4 text-end">
                                    ...
                                    <i class="ri-add-circle-line label-icon align-middle fs-16"></i> New Farm </button>

                                    <button wire:click="exportToExcel" class="btn btn-warning">
                                    <i class="ri-file-excel-2-line fs-14"> </i> Export
                                </button>
...
<div class="table-responsive">
        ...
        <thead class="table-light">
            <tr>
                <th>ID</th>
                <th>Farm Name</th>
                <th>Farm Address, Email &  Phone</th>
                <th>Discount</th>
                <th>Limits</th>
                <th>Balance</th>
                <th>Actions</th>
        ...
        <tbody>
            ...
            @foreach($customers as $customer)
                ...
                <td style="word-wrap: break-word; white-space: normal;">
                    <span class="text-uppercase badge bg-info-subtle text-info  fw-bold fs-12">
                ...
                <td>
                    ...
                    <td>
                        <div class="hstack gap-1 flex-wrap">
                            @can('customers edit')
                            <a wire:click="edit({{ $customer->id }})" href="javascript:void(0);" class="link-success fs-15"><i class="ri-edit-2-line" style="font-size:16px;"></i></a>
                            @endcan

                            @can('customers delete')
                                <a wire:click="confirmDeletion({{ $customer->id }})" href="javascript:void(0);" class="link-danger fs-15">
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="myModal_customerLabel">{{ $isEditMode ? 'Edit Farm' : 'Add Farm' }}</h5>
                ...
                <div class="modal-body">
                    <form>
                        ...
                        <div class="row mb-2">
                            <div class="col-md-6 mb-2">
                                <div class="form-group">
                                    <label for="account_name">Farm Name</label>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="group_id">Farm Group</label>
                                    <select wire:model="group_id" class="form-select">
                                        <option value="">Select Group</option>
                                        @foreach (App\Models\ChartOfAccountGroup::where('is_customer_vendor', 'farm')
                                            ->where('company_id', session('company_id')) // Filter by company_id from session
                                            ->get() as $group)
                        ...
                        <div class="col-md-4 d-none">
                            <div class="form-group ">
                                    <label for="is_farm">Is Farm?</label>
                                        <select wire:model="is_farm" class="form-select" required>
                                        <option value="">---Select ---</option>
                                        <option value="0">No, This is not a Farm.</option>
                                        <option value="1">Yes, This is a Farm.</option>
                                    </select>
                                    @error('is_farm') <span class="text-danger">{{ $message }}</span> @enderror
                            </div>
                        </div>
...
$wire.on('swal:confirm-deletion', ({ voucherId }) => {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                @this.call('deleteCustomer', voucherId);  // Call the delete method with the voucher ID
            }
        });
    });
