                        ...
                        <td rowspan="{{ count($return->items) }}">
                            <div class="d-flex align-items-center">
                                ...
                                <div>
                                    ...
                                    <span class="text-success text-uppercase">{{ \App\Models\ChartofAccount::find($return->customer_id)->name ?? 'N/A' }}</span>
                                    </h5>
                                    <span class="text-muted">{{ \App\Models\CustomerDetail::where('account_id', $return->customer_id)->with('coaGroupTitle')->first()->coaGroupTitle->name ?? 'N/A' }}</span>
                                </div>
                            </div>
                        </td>
                    @endif
        ...
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                ...
                <div class="modal-header card-header align-items-center pb-2">
                    <h4 class="card-title mb-0 flex-grow-1">{{ $isEditMode ? 'Edit Sales Return' : 'Add New Sales Return' }}</h4>
                ...
                <div class="modal-body">
                    ...
                    <div class="form-section">
                        <div class="row">
                            ...
                            <div class="col-md-8 mb-3">
                                ...
                                <select wire:model="customer_id" class="form-control form-select shadow-sm">
                                    <option value="">-- Select Customer --</option>
                                    @foreach($customers as $customer)
                                        <option value="{{ $customer->id }}">{{ $customer->name }}</option>
                                    @endforeach
                    ...
                    <div class="form-section">
                        <h5 class="mt-2 tabheading">Add / Remove Products</h5>
