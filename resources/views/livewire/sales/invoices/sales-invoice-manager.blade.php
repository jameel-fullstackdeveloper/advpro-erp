...
<!-- Spinner element -->
<div wire:loading wire:target="store, update, delete,create, startDate, endDate, selectedCustomer, itemsPerPage,selectedItem, selectedGroup, selectedBroker, serach" class="spinner"></div>
                ...
                <tbody>
                    <tr>
                        ...
                        @can('sales invocies create')
                            <a href="{{ url('sales/invoices/create') }}" class="btn btn-success btn-label waves-effect waves-light">
            ...
            <table class="table table-bordered table-striped table-hover align-middle text-center">
                ...
                <tbody class="table-light">
                    <tr>
                        ...
                        <td class="fs-14 fw-bold text-danger">{{ number_format($totalBonustu) }}</td>
    ...
    <table class="table table-centered align-middle table-nowrap mb-0">
        <thead class="table-light">
                <tr>
                    ...
                    <th>Customer</th>
                    <th>Product(s)</th>
                    <th>Unit Price <br/><span class="text-dark" style="font-size:10px">Per Bag
                    </span></th>
            ...
            <tbody>
                ...
                @foreach($invoices as $invoice)
                    ...
                    <tr>
                        ...
                        <!-- Product Information -->
                        <td>
                        <strong title="{{ $products->find($item->product_id)->product_name ?? 'N/A' }}">
                                    {{
                                        Str::words($products->find($item->product_id)->name ?? 'N/A', 2, ' ...')
                                    }}
                                </strong><br/>
    ...
    <td rowspan="{{ count($invoice->items) }}">
        <div class="d-flex align-items-center gap-1">
            @can('sales invocies edit')
                <a href="{{ route('invoices.edit', $invoice->id) }}" class="link-success fs-15" title="Edit Invoice">
...
@endif
                ...
                <tfoot class="table-info">
                    <tr>
                        ...
                        <th class="text-danger">{{ number_format($totalDiscountPerBag1,2) }}</th>
                        ...
                        <th></th>
                        <th class="d-none">{{ number_format($totalFreight1) }}</th>
                        <th class="d-none">{{ number_format($totalbrokery,2) }}</th>
