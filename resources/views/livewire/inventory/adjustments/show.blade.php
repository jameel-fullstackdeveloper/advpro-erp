        ...
        <div class="col">
            <div class="card">
                <div class="card-header align-items-center d-flex">
                    <h4 class="card-title mb-0 flex-grow-1">Stock Adjustments</h4>
                    <!-- export test -->
                    <!--<button wire:click="export" class="btn btn-success">Export</button>-->
                    <div class="flex-shrink-0">
                        <div class="form-check form-switch form-switch-right form-switch-md">
                        <button type="button" wire:click="create()" class="btn btn-info btn-label">
        ...
        <tbody>
            @foreach ($stockMaterialAdjustments as $adjustment)
                <tr>
                    ...
                    <td style="word-wrap: break-word; white-space: normal;font-weight:bold;">{{ $adjustment->purchaseItem->name ?? 'N/A' }}</td>
