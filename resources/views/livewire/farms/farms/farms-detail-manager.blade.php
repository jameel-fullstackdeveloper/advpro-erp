...
<div class="table-responsive">
        ...
        <tbody>
            ...
            @foreach($customers as $customer)
                ...
                <td><span class="text-primary" style="font-weight:600;">
                    ...
                    <td>
                        <div class="hstack gap-3 flex-wrap">
                            ...
                            @can('customers delete')
                                    <a wire:click="confirmDeletion({{ $customer->id }})" href="javascript:void(0);" class="link-danger">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select wire:model="group_id" class="form-select">
                                        ...
                                        @foreach (App\Models\ChartOfAccountGroup::where('is_customer_vendor', 'farm')->get() as $group)
...
$wire.on('swal:confirm-deletion-farm', ({ farmId }) => {
        Swal.fire({
            title: 'Are you sure?',
            ...
            if (result.isConfirmed) {
                @this.call('deleteCustomer', farmId);  // Call the delete method with the voucher ID
            }
        });
    });
