...
<!-- Spinner element -->
<div wire:loading wire:target="itemsPerPage,store, update, create, start_date, end_date,filer_vendor_id, filter_items, searchTerm" class="spinner"></div>
    ...
    <tr>
        ...
        @can('purchases bills create')
            <a href="{{ url('purchase/bills/create') }}" class="btn btn-success btn-label waves-effect waves-light">
...
<div class="row mb-1 d-none">
    ...
    <thead class="table-light" style="vertical-align: middle;">
                        <tr>
                            <th class="text-center text-info">Bill Detail</th>
                            <th class="text-center text-info">Vendor Detail</th>
                            <th class="text-center text-info">Product</th>
                            <th class="text-center text-info">Mode</th>
                            ...
                            <th class="text-center text-info">Quantity <br/><span class="text-dark" style="font-size:10px">After Deduction</span></th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            @if($bill->delivery_mode == 'delivered')
                            ...
                            <td  class="d-none">
                                ...
                                @else
                                    <span class="badge bg-info">Init</span>
                                @endif

                                @if($bill->is_weighbridge ==1)
                            ...
                            <div class="hstack gap-1 flex-wrap">
                                ...
                                @can('purchases bills edit')
                                    ...
                                    <a href="{{ route('bills.edit', $bill->id) }}" class="link-success fs-15" title="Edit Bill">
                    ...
                    <tfoot class="table-info">
                        <tr>
                            ...
                            <!--<th>{{ number_format($totalFreightAmount, 2) }} </th>
                            <th>{{ number_format($totalBrokrageAmount, 2) }} </th>-->
                            <th colspan="2"></th>
                        </tr>
                    </tfoot>
                </table>
