                            ...
                            <a onclick="confirmDeletionCustomer{{ $customer->id }}({{ $customer->id }})" href="javascript:void(0);" class="link-danger fs-15">
                                ...
                                <div class="dropdown">
                                                                <a href="#" role="button" id="dropdownMenuLink1" data-bs-toggle="dropdown" aria-expanded="true" class="show">
                                                                    <i class="ri-more-2-fill text-dark"></i>
                                                                </a>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="myModal_customerLabel">{{ $isEditMode ? 'Edit Vendor' : 'Add Vendor' }}</h5>
                ...
                <div class="modal-body">
                    <form>
                        ...
                        <div class="row mb-2">
                            <div class="col-md-6 mb-2">
                                <div class="form-group">
                                    <label for="account_name">Vendor Name</label>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="group_id">Vendor Group</label>
                                    <select wire:model="group_id" class="form-select">
                                        <option value="">Select Group</option>
                                        @foreach (App\Models\ChartOfAccountGroup::where('is_customer_vendor', 'vendor')
                        ...
                        <div class="row mb-2">
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="cnic">CNIC <small>(Sales Tax Registration Number)</small></label>
